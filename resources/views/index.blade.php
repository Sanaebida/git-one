...
<section class=" flex min-h-screen items-center mx-auto text-centere">
<main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
    <div class="sm:text-center lg:text-left">
      <h1 class="text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
        <span class="block xl:inline">un syndic de copropriété</span>
        <span class="block text-indigo-600 xl:inline">engagé à vos côtés</span>
      </h1>
      <p class="mt-3 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Gérez votre Carnet d'entretien de copropriété et suivez tout ce qui concerne le syndic, la service à distance qui vous permet d’accéder à de nombreuses fonctionnalités en ligne où que vous soyez.</p>
      <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
        <div class="rounded-md shadow">
          <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"> S'inscrire </a>
        </div>
        <div class="mt-3 sm:mt-0 sm:ml-3">
          <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10">plus d'informations</a>
        </div>
      </div>
    </div>
  </main>
...
<section>
  <div class="bg-gray-300 grid grid-cols-2 divide-x">
    <div>
      <main class="mt-10 mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h1 class="text-2xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-4xl">
            <span class="block text-indigo-700 xl:inline">chaque copropriété</span>
            <span class="block xl:inline">est gérée avec transparence,
              dynamisme et efficacité.</span>
          </h1>
          <p class="mt-3 text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Chaque copropriété doit avoir un syndic pour l'administrer et gérer ses finances , Notre Service met à disposition des copropriétaires un espace extranet sécurisé permettant d’avoir accès à l’ensemble des informations qui concernent la gestion de la copropriété.</p>
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"> S'inscrire </a>
            </div>
    ...
    <div>
      <img src="https://ibsdocs.com.br/solucoes/verticais/industria/mulher-mexendo-no-celular-com-notebook.jpg" alt="Avatar man">
    </div>
  </div>
</section>
      ...
      <div>
        <div class="flex flex-wrap -mx-6 lg:-mx-8">
          <div class="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-20 lg:mb-0">
            ...
            <h3 class="mt-12 mb-8 text-lg font-bold font-heading text-white">Gestion</h3>
            <p class="text-lg text-gray-200">Creér, Elaborer et tenir à jour le carnet d'entretien de l'immeuble.</p>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-10 lg:mb-0">
            ...
            <div class="pb-px mb-12 bg-gray-500"></div>
            <h3 class="mt-12 mb-8 text-lg font-bold font-heading text-white">Documents</h3>
            <p class="text-lg text-gray-200">un accès en ligne aux documents qui concernent la gestion de la copropriété gérés.</p>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8">
            ...
            <div class="pb-px mb-12 bg-gray-500"></div>
            <h3 class="mt-12 mb-8 text-lg font-bold font-heading text-white">Backups</h3>
            <p class="text-lg text-gray-200">Les documents mis à disposition sont toujours téléchargeables et imprimables.</p>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-20 lg:mb-0">
            ...
            <div class="pb-px mb-12 bg-gray-500"></div>
            <h3 class="mt-12 mb-8 text-lg font-bold font-heading text-white">regular updates</h3>
            <p class="text-lg text-gray-200">rester à jour avec les informations techniques liées à la maintenance et aux travaux effectués dans l'immeuble.</p>
          </div>
        </div>
      </div>
    </div>
